package org.ruslan.todo.mc.entity;
...
@Entity
@Table(name = "task", schema = "todo", catalog = "ukkrqftv")
@NoArgsConstructor
@AllArgsConstructor
@Setter
@Getter
...
public class Task implements Serializable {
    ...
    private org.ruslan.todo.mc.entity.Priority priority;
    ...
    private org.ruslan.todo.mc.entity.Category category;
