...
public class SetInitDataController {
    ...
    public SetInitDataController(TaskService taskService, PriorityService priorityService, CategoryService categoryService) {
    ...
    public ResponseEntity<Boolean> init(@RequestBody Long userId) {
        ...
        // set task
        Task task1 = new Task();
        task1.setTitle("Завершить 1-ый проект");
